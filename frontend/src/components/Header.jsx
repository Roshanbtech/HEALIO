  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-red-600 rounded-lg px-4 md:px-6 lg:px-10">
      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-6 m-auto md:py-[8vw] md:mb-[-20px]">
        ...
        <a
          href="#speciality"
          className="flex items-center gap-2 bg-white px-6 py-2 rounded-full text-green-900 text-sm m-auto md:m-0 hover:text-white hover:bg-green-900 hover:scale-105 transition-all duration-300"
        >
          Book appointment{" "}
